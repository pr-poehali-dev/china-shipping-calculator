    ...
    const rates: ShippingRate[] = [
      {
        ...
        price: Math.round(chargeableWeight * baseRates.sea * cityMultiplier),
        days: "25-35 дней",
        icon: <Ship className="w-5 h-5" />,
      },
      {
        method: "Железная дорога",
        price: Math.round(chargeableWeight * baseRates.rail * cityMultiplier),
        days: "15-20 дней",
        icon: <Train className="w-5 h-5" />,
      },
      {
        method: "Авиадоставка",
        price: Math.round(chargeableWeight * baseRates.air * cityMultiplier),
        days: "5-7 дней",
